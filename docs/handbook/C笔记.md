...
![Img](./FILES/4.md/img-20230506200607.png)
...
![Img](./FILES/4.md/img-20230505221719.png)
...
![Img](./FILES/4.md/img-20230505221840.png)
...
![Img](./FILES/4.md/img-20230506223237.png)

在程序中输入Hello World 然后在内存中只看到hello进来了，而world没进来。

![Img](./FILES/4.md/img-20230506223636.png)

原因是``scanf在%s``遇到空格或回车是被截断符截断了。因此可以在%s前面加一些修饰如：`` scanf("%[0-9]s", szBuf);`` 得到

![Img](./FILES/4.md/img-20230506224233.png)
